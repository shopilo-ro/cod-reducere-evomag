#!/usr/bin/env node
/**
 * Fetch coduri reducere evoMAG de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/evomag.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/evomag.ro";
const STORE_NAME  = "evoMAG";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-evomag)" }
  });
